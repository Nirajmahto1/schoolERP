...
| `apps/mobile` | Expo 54 / RN 0.81 / nativewind. 2,285 lines. Skeleton. *(RETIRED — replaced by `apps/mobile_flutter`, the Flutter/Dart port with the same three role experiences; see the retirement commit.)* |
