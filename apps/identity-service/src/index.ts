// ──────────────────────────────────────────────
// School ERP — Identity Service entrypoint
// Login, MFA, sessions, invites, password reset, permission resolution,
// impersonation-with-audit (BUILD_PLAN Phase 3.1).
// ──────────────────────────────────────────────
